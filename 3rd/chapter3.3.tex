\section{実験方法}
本節では，事前準備と本実験からなる2段階の実験手順について詳述する．実験は，システムによる段階的な楽曲推薦を行う群（推薦あり群）と，支援を行わない群（推薦なし群）の2群で比較を行う．
...
また，図\ref{fig:classified_songs}に，分類済みの楽曲一覧を確認できる画面を示す．この画面では，分類が完了した楽曲の一覧を表示する．被験者は，自身が分類した楽曲を確認することができる．また，再度の分類もできるようにした．
